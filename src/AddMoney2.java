 ...
 * @author Hp
 */
public class AddMoney2 extends javax.swing.JFrame {

    /**
     * Creates new form AddMoney2
     */
    String accountNumber,bkashNumber,amount,type1,type2;
    Date dateAndTime;
    public AddMoney2(String accountNumber,String bkashNumber,String amount,String type1,String type2,Date dateAndTime) {
    ...
    private AddMoney2(String string, String string0, String string1, String string2, String string3) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    /*AddMoney2(String accountNumber, String bkashNumber, String amount, String type1, String type2, Date dateAndTime) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }*/
    ...
    private void initComponents() {
        ...
        depositAmountButton.setText("Add Money");
        ...
        adminPanelLabel.setText("ADD MONEY");
        ...
        balanceDepositWithdrawTransferLabel.setText("Bkash");
    ...
    private void depositAmountButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_depositAmountButtonActionPerformed
       ...
       if(otpTextField.getText().equals("5695"))
        {
            String query1="insert into balance values('"+accountNumber+"', '"+dateAndTime+"', '"+type2+"', '"+amount+"')";
            try {
            ...
            String query2="insert into balance values('"+bkashNumber+"', '"+dateAndTime+"', '"+type1+"', '"+amount+"')";
            try {
                c.s.executeUpdate(query2);
            } catch (SQLException ex) {
                Logger.getLogger(AddMoney2.class.getName()).log(Level.SEVERE, null, ex);
            }
            JOptionPane.showMessageDialog(null,amount+" Taka Deposit Sucessfully!!!");
            Transfer T;
            try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddMoney2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
