 ...
 * @author Hp
 */
public class TransferOther1 extends javax.swing.JFrame {

    /**
     * Creates new form TransferOther1
     */
    String accountNumber;
    public TransferOther1(String accountNumber) {
    ...
    private void initComponents() {
        ...
        enterdepositAmountLabel.setText("Enter Transfer Amount");
        ...
        depositAmountButton.setText("Next");
        ...
        admin12_2PanelLayout.setHorizontalGroup(
            ...
            .addGroup(admin12_2PanelLayout.createSequentialGroup()
                ...
                .addGroup(admin12_2PanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(enterDepositAmountTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 301, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void depositAmountButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_depositAmountButtonActionPerformed
        ...
        try{
                ...
                bank.equals("Select"))
            {
                ...
                Conn c=new Conn();
                String query="select * from AddBank where AccountMobileNumber = '"+bkashNumber+"' and Bank = '"+bank+"'";
                ...
                if(rs.next())
                {
                    ...
                    TransferOther2 T2= new TransferOther2(accountNumber,bkashNumber,amount,type1,type2,dateAndTime);
                    setVisible(false);
                    T2.setVisible(true);
                    dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TransferOther1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TransferOther1("").setVisible(true);
            }
        });
    }
